...
Tourcomment.create!(:tour => Tour.first, :commenter => User.find(3), :content => 'up thêm hình được không ad')

Tour.first.rated_up_by(User.find(1))
Tour.first.rated_up_by(User.find(2))
Tour.first.rated_up_by(User.find(3))
Tour.first.rated_down_by(User.find(4))