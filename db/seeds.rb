...
User.create!(:id => 290, :username => "AnVo", :name => "anvo", :email => "akira.an111@gmail.com", :password => "passwordanvo", :avatar => Faker::Avatar.image)
...
t2 = Tour.create!(:title => "Du lich Da Nang Hoi An 7 ngay",
 :fromplace => "Nga 4 Phu Nhuan, tp. Ho Chi Minh",
 :toplace => "tp. Thap Cham, tinh Phan Rang",
 :fromtime => DateTime.parse('Tue, 6 Sep 2016 7:00 AM+0700'),
 :totime => DateTime.parse('Sat, 10 Sep 2016 7:00 AM+0700'),
 :maxmember => 2, :creator_id => 4, :estimatebudget => 2000000,
 :deposit => 500000, :transport => "Tau lua",
 :description => "DI du lich 2 ngay 3 dem tai Phan Rang Thap Cham")
